        ...
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers("/", "/login","/swagger-ui/**", "/v3/api-docs/**","/swagger-resources/**",
                                "/webjars/**","/api/v1/login").permitAll()
...
//                        .accessDeniedHandler(new BearerTokenAccessDeniedHandler())) // Custom 403 handler
    ...
    public JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        grantedAuthoritiesConverter.setAuthoritiesClaimName("duyhung");
