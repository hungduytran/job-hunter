...
public class SecurityConfiguration {
    ...
    public JwtAuthenticationConverter jwtAuthenticationConverter() {
        ...
        grantedAuthoritiesConverter.setAuthorityPrefix("");  // Không dùng tiền tố cho authorities
        grantedAuthoritiesConverter.setAuthoritiesClaimName("permission");  // Dùng claim 'permission' để xác định quyền
